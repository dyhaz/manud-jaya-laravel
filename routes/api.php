...
Route::get('/perizinan/summary/{email}', [\App\Http\Controllers\PerizinanController::class, 'getPerizinanStatus']);
...
Route::post('/landing-page', [\App\Http\Controllers\LandingPageController::class, 'update']);
